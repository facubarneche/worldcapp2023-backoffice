...
describe('Tests DashboardBox', () => {
  it('Al renderizar se obtienen los valores correctos', () => {
    ...
    //Assert
    const figuritasOfrecidasNombre = screen.getByTestId('Figuritas Ofrecidas-description')
    const figuritasOfrecidasCantidad = screen.getByTestId('Figuritas Ofrecidas-number-quantity')
    expect(figuritasOfrecidasNombre).toHaveTextContent('Figuritas Ofrecidas')
    expect(figuritasOfrecidasCantidad).toHaveTextContent('13')
  })
